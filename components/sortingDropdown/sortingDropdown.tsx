...
export default function SortingDropdown({
  ...
  return (
    <div className="relative z-50 flex flex-col gap-2">
      ...
      <ul className={`absolute shadow-modal-box border border-solid border-gray-20 rounded-[5px] overflow-hidden text-[14px] w-full top-[120%] bg-white ${isDropdownOpened ? 'block' : 'hidden'} `}>
