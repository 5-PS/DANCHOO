...
export default function MyProfileEditPage({params} : {params : {userId : string | string[]}}) {
  return (
    <div className="w-full px-3 pt-10 pb-20 md:py-[60px] md:max-w-[680px] md:m-auto xl:max-w-[964px]">
      <div className="flex items-center justify-between mb-6 md:mb-8 ">
        ...
        <Link href={`/my-profile/${params.userId}`} className="relative w-6 h-6 md:w-8 md:h-8">
