...
export default function MyStoreForm() {
  ...
  const previewImg = changeImgSrc ? (
    ...
    <Image src={imageSrc} fill alt="미리보기 이미지" />
  );
  return (
    <form onSubmit={handleSubmit((data) => onSubmit(data))}>
      <div className="flex flex-col gap-6 mb-6 md:mb-8">
        ...
        <div className="w-full md:w-[483px]">
          ...
          <label
            htmlFor="image-input"
            className={`flex flex-col gap-3 font-bold text-white w-full max-w-[375px] h-[201px] md:max-w-full md:h-[276px] ${changeImgSrc || 'bg-black opacity-70'} ${!imageSrc && 'border-gray-20 '}  rounded-xl justify-center items-center cursor-pointer relative overflow-hidden`}
          >
